...
public class XStatusBar {
    ...
    public XStatusBar(Activity activity) {
        this.activity = activity;
    }

    private ColorBuilder colorBuilder;

    private XStatusBar(Activity activity, ColorBuilder builder) {
        this.activity = activity;
    ...
    private XStatusBar(Activity activity, TransparentBuilder builder) {
        this.activity = activity;
    ...
    private XStatusBar(Activity activity, ImmersionBuilder builder) {
        this.activity = activity;
    ...
    private XStatusBar(Activity activity, DrawerBuilder builder) {
        this.activity = activity;
    ...
    private XStatusBar(Activity activity, HideBuilder builder) {
        this.activity = activity;
        this.type = TYPE_HIDE;
    ...
    public static class ColorBuilder {
        ...
        public XStatusBar build(Activity activity) {
            return new XStatusBar(activity, this);
        }
